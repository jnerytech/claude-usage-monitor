...
<reference>
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/repos/claude-usage-monitor/.claude/get-shit-done/references/user-profiling.md` to load:

...
Use template from `D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/UI-SPEC.md`

...
<required_reading>
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/repos/claude-usage-monitor/.claude
                  → checks D:/repos/claude-usage-monitor/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/repos/claude-usage-monitor/.claude/get-shit-done
                  → writes to D:/repos/claude-usage-monitor/.claude/get-shit-done/hooks/
...
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/repos/claude-usage-monitor/.claude/get-shit-done/references/common-bug-patterns.md

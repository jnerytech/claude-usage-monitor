...
Reference full template: `D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/state.md`.

...
```bash
INIT=$(node "D:/repos/claude-usage-monitor/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/spec.md.

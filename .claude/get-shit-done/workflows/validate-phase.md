...
```
Task(
  prompt="Read D:/repos/claude-usage-monitor/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/VALIDATION.md`

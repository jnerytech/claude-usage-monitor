...
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/ui-brand.md
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/revision-loop.md
@D:/repos/claude-usage-monitor/.claude/get-shit-done/references/gate-prompts.md
...
**If found:**
1. Read template: `D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @D:/repos/claude-usage-monitor/.claude/get-shit-done/references/tdd.md to all eligible tasks:

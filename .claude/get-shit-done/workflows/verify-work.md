...
Read and follow `D:/repos/claude-usage-monitor/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @D:/repos/claude-usage-monitor/.claude/get-shit-done/workflows/diagnose-issues.md

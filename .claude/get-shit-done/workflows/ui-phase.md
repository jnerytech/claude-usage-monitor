...
```markdown
Read D:/repos/claude-usage-monitor/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/repos/claude-usage-monitor/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/repos/claude-usage-monitor/.claude/agents/gsd-ui-checker.md for instructions.

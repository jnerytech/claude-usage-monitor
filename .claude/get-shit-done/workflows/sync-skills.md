...
INSTALL_JS_GLOBAL="D:/repos/claude-usage-monitor/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/repos/claude-usage-monitor/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

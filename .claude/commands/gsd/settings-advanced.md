...
<execution_context>
@D:/repos/claude-usage-monitor/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@D:/repos/claude-usage-monitor/.claude/get-shit-done/workflows/settings-advanced.md`.
